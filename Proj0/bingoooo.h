...
public:
     ...
     * been allocated.
     * 
     * @note Uses generateNumbers() to create a 2D-matrix of vectors "intervals" (20% of the range from min to max inclusive). 
     * "intervals" is used to populate the m_card with values with the constraint defined in the documentation. 
     *
...
private:
    ...
    vector <int> generateNums(int min, int max);
